...
//    }
    ...
    func RGsetMenuViewController(_ menuVC : UIViewController)->Void{
    ...
    func RGsetMainViewController(_ mainVC : UIViewController)->Void{
        closeMenu()
...
//        }
    ...
    func openMenu(){
        ...
        UIView.animate(withDuration: 1.0, delay: 0.0, usingSpringWithDamping: 0.5, initialSpringVelocity: 0.5, options: UIViewAnimationOptions.curveLinear, animations: { () -> Void in
